...
if(!isset($_SESSION["loggedin"])) {
    die("<h2>You must be logged in to submit an answer.<h1>");
}
?>
...
<p class="centertext">SUBMIT A NEW ANSWER</p>

<form id="form_q" action="" method="post">
    <fieldset>
        <label for="form_a_input">Answer:</label><br/>
        <textarea name="form_a_input" id="form_a_input" rows="10" cols="50"></textarea><br/>
        <p id="char_counter">Character Count: 0/800</p>
